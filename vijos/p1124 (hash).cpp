...
#include <iostream>
using namespace std;
int n, len1[10], len2[10], ans, f[100010], mo=100007;
char s1[30], s2[30], a[10][30], b[10][30], l1[500][100],  l2[500][100];
int func(char s[60]){
    int tmp=0;
    for (int i=0;i<strlen(s);i++) tmp = (tmp * 131 + s[i])%mo;
    return tmp;
}
int main(){
    scanf("%s %s\n", s1, s2);
